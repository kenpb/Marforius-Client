...
TESTED ON ENUS
<b>HAS NOT BEEN TESTED WITH OTHER LOCALES</b>


= Why should I use this?

* To reduce the client's size on disk by 4.1 GBs.
* To unlock all (except the hardcoded ones) the protected methods in Lua.
...
* Edit anything, create anything, have full control over the client.
...
Repacker.exe will return false positives, it is packed with FSG (Fast Small Good) and I do not have the sourcecode for another. I have ran this myself and, it works rather well. However, I haven't unpacked it to see why the creator thought they needed to use a packer on it. So perhaps run it in a sandbox.
...
http://s007.radikal.ru/i300/1010/8b/62ede706158a.png


Launcher::
   A copy of the 3.3.5 Wotlk launcher, with some additions.

http://suxorz.com/i5/launcher.png
